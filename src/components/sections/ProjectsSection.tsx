...
const projects = [
    ...
    },
    {
        ...
        subtitle: 'Zero-Config Logistics & Retail Analytics',
        description: 'A zero-config logistics & retail analytics dashboard — upload any CSV and instantly get 16 interactive charts, KPI cards, geospatial maps, correlation matrices, and export tools. Full dark-mode UI with neon accent theme.',
        icon: '📦',
        color1: '#f56565',
        color2: '#ed8936',
